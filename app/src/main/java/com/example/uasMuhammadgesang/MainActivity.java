 ...
 OvershootInterpolator interpolator = new OvershootInterpolator();
    ...
    private void showmenu() {
        ...
        fthree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.uasMuhammadgesang.MainActivity, ScanActivity.class);
        ...
        ftwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.uasMuhammadgesang.MainActivity, DataActivity.class);
                startActivity(intent);
            }
        });
